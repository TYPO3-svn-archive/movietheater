...
$LANG->includeLLFile('EXT:movietheater/mod1/locallang.xml');
 ...
 */
class  tx_movietheater_module1 extends t3lib_SCbase {
	...
	function printContent()	{
		...
		print("	<title>tx_movietheater_module1</title>\n");
	...
	function display()	{
		...
		$films = $GLOBALS['TYPO3_DB']->exec_SELECTgetRows ('*','tx_movietheater_films','');
		return t3lib_div::view_array($films);
	}
	
}

if (defined('TYPO3_MODE') && $TYPO3_CONF_VARS[TYPO3_MODE]['XCLASS']['ext/movietheater/mod1/index.php'])	{
	include_once($TYPO3_CONF_VARS[TYPO3_MODE]['XCLASS']['ext/movietheater/mod1/index.php']);
}

// Make instance:
$SOBE = t3lib_div::makeInstance('tx_movietheater_module1');
$SOBE->init();
