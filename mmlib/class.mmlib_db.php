...
****************************************************************
require_once(t3lib_extMgm::extPath('movietheater').'mmlib/class.mmlib_db.php');
***************************************************************/
...
class mmlib_db{
	...
	public static function count($table,$where='',$group='',$order='',$limit=''){
		$where = mmlib_db::where($where,$table);
		$result = $GLOBALS['TYPO3_DB']->exec_SELECTgetRows('COUNT(*)',$table,$where,$group,$order,$limit);
...
if (defined('TYPO3_MODE') && $TYPO3_CONF_VARS[TYPO3_MODE]['XCLASS']['ext/movietheater/mmlib/class.mmlib_db.php'])	{
	include_once($TYPO3_CONF_VARS[TYPO3_MODE]['XCLASS']['ext/movietheater/mmlib/class.mmlib_db.php']);
}
?>